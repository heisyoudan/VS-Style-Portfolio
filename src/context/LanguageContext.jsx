            ...
            items: [
                {
                    ...
                    industry: "業種：製鋼業",
                    desc: "製鋼所の生産現場をデジタル空間上に再現し、現場で発生するさまざまなデータを連携・集約できるシステムを構築しました。三次元空間による可視化により、現地に行かなくても生産状況を直感的に把握できるようにし、関連データや映像との連携によって、より正確かつ迅速な状況判断を支援しました。<br><br><b>担当範囲:</b> Unity フロントエンドの実装を一貫して担当し、API 連携、3D モデル制御、ユーザーインタラクションの実装を行いました。",
                ...
                },
                {
                    title: "VR消火訓練体験",
                    industry: "業種：水力発電",
                    desc: "水力発電所の従業員向けに開発した VR 消火訓練アプリです。没入感のある空間表現によって、消火訓練の安全性と臨場感を高めました。実際の火を使わずに、火災に近い状況を再現した訓練を効率的に行えるようにしました。<br><br><b>担当範囲:</b> 要件整理、提案・設計、技術構成の検討、実装、テスト、受け入れ対応、納品支援まで一貫して担当しました。立ち上げからリリースまで単独で担当したプロジェクトです。",
                ...
                },
                {
                    title: "高所作業墜落体験",
                    industry: "業種：水力発電",
                    desc: "高所作業における安全教育向けの没入型体験アプリです。墜落事故の状況や恐怖感を再現することで、作業者の安全意識を高め、危険認識の向上と事故防止につなげました。<br><br><b>担当範囲:</b> 要件整理、提案・設計、技術構成の検討、実装、テスト、受け入れ対応、納品支援まで一貫して担当しました。立ち上げからリリースまで単独で担当したプロジェクトです。",
                ...
                },
                {
                    ...
                    industry: "業種：水力発電",
                    desc: "Hi5 VR グローブを活用した没入型訓練システムです。仮想空間内で、繰り返し実技確認が必要な訓練を高い再現度で体験できるようにし、訓練効率と現場作業への習熟度向上を支援しました。<br><br><b>担当範囲:</b> 要件整理、提案・設計、技術構成の検討、実装、テスト、受け入れ対応、納品支援まで一貫して担当しました。立ち上げからリリースまで単独で担当したプロジェクトです。",
                ...
                },
                {
                    title: "ARグラス巡視支援アプリ",
                    industry: "業種：水力発電",
                    desc: "現場巡視を支援する AR アプリです。作業者は AR グラス上でデジタル化された作業手順を確認でき、現場の映像と音声を遠隔の技術者へリアルタイムに共有できます。遠隔支援側は、注記付きの画像や指示内容を作業者の視界上に表示でき、巡視の効率向上と円滑な連携を実現しました。<br><br><b>担当範囲:</b> 要件整理、提案・設計、技術構成の検討、実装、テスト、受け入れ対応、納品支援まで一貫して担当しました。立ち上げからリリースまで単独で担当したプロジェクトです。",
                ...
                },
                {
                    ...
                    industry: "業種：金融・決済システム",
                    desc: "大手企業の決済基盤を対象としたモダナイゼーションプロジェクトです。技術先行メンバーとして新技術の導入検証とチームの開発力向上を推進し、後続開発の実装方針整備を支援しました。<br><br><b>担当範囲:</b> gRPC および AWS DynamoDB の実現性検証と先行開発、技術実装レポートや開発ガイドの作成、さらに GitHub Copilot の活用検証と標準化された開発フローの整備を担当しました。",
                ...
                },
                {
                    ...
                    desc: "SwiftUI で開発した macOS メニューバー向けのシステムモニタリングツールです。CPU、メモリ、ネットワークの状態を、ミニマルなデザインで軽快かつ直感的に確認できる体験を目指しました。<br><br><b>担当範囲:</b> UI / UX 設計、機能実装、アプリ公開までを個人で一貫して担当しました。Swift 未経験の状態から AI を活用して製品化まで進め、Apple らしいミニマルな操作体験を追求しました。",
