    ...
    ja: {
        ...
        about: {
            ...
            content: `
                ...
                <p>私は、空間的なインタラクションの視点と、バックエンドの設計力を両軸に、設計から実装・検証・リリースまでを一気通貫で進めるタイプのエンジニアです。</p>
                <p>来日前は中国で約4年間、Unity を用いた VR/AR 開発に従事し、業務向けの可視化や体験設計、実装から納品までの一連の開発を経験しました。この経験が、複雑な要件を整理して形にする力と、プロダクト視点での実装力の土台になっています。</p>
                <p>2022年の来日以降は、Java（Spring Boot）を中心としたクラウドネイティブ開発へ領域を広げ、現在は日本大手企業の決済基盤モダナイズ案件に参画しています。技術検証担当として、主に以下を担当しています：</p>
                <ul style="padding-left: 20px; list-style-type: disc; margin-bottom: 20px;">
                    <li>gRPC や AWS DynamoDB など新規採用技術の先行検証（PoC）と、実装サンプルの作成</li>
                    <li>検証結果の整理とドキュメント化による、開発方針検討の支援</li>
                    <li>GitHub Copilot を含む AI 活用の進め方を整理し、チーム内で共有できる形に整備</li>
                </ul>
                <p>また個人開発では、AI を開発ワークフローに組み込み、Swift を用いた macOS 効率化アプリ（Vortex、Omit など）を短期間で開発・リリースしています。技術の幅と実装の深さを両立し、価値ある成果物として届けることを大切にしています。</p>
            `,
            career_title: "経歴概要",
            skills_title: "スキル概要"
        },
    ...
    zh: {
        ...
        about: {
            ...
            content: `
                ...
                <p>我是一名兼具空间交互视角与后端架构思维的工程师，擅长从需求整理、方案设计到实现、验证、交付的全流程推进。</p>
                <p>来日前我在中国从事约4年 Unity VR/AR 开发，面向业务场景做过可视化与交互体验设计，并负责从实现到交付的完整链路。这段经历让我具备把复杂需求拆解成可落地方案的能力，也养成了以产品结果为导向的工程习惯。</p>
                <p>2022年移居日本后，我将方向扩展到以 Java（Spring Boot）为核心的云原生开发。目前参与日本大型企业的支付基盘现代化项目，负责技术验证相关工作，主要包括：</p>
                <ul style="padding-left: 20px; list-style-type: disc; margin-bottom: 20px;">
                    <li>对 gRPC、AWS DynamoDB 等新引入技术进行 PoC 验证，并制作实现样例</li>
                    <li>汇总验证结论并文档化，支持团队在实现方案与开发方针上的决策</li>
                    <li>梳理 GitHub Copilot 等 AI 工具在团队开发中的用法，形成可复用的流程与知识沉淀</li>
                </ul>
                <p>在个人开发方面，我把 AI 融入日常开发工作流，使用 Swift 快速开发并发布 macOS 效率工具（Vortex、Omit 等）。我希望用技术广度与工程深度，把想法更快、更稳地交付成可用的产品。</p>
            `,
            career_title: "经历概要",
            skills_title: "技能概要"
        },
